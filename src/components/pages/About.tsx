...
export const About = () => {
  ...
  const pageList = [<CourseBox />, <About_Box />];
  const pageTitles = ["Relevant Coursework", "Get To Know Me"];
  ...
  return (
    <div className="flex flex-col items-center mb-28 gap-5 bg-[#E0E1DD] ">
      ...
      <div
        className="md:w-[1000px] md:h-[600px] bg-[#E0E1DD] flex flex-col items-center mt-10 "
